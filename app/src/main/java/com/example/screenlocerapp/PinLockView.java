...
import com.example.screenlocerapp.CustomizationOptionsBundle;
import com.example.screenlocerapp.ItemSpaceDecoration;
import com.example.screenlocerapp.LTRGridLayoutManager;
import com.example.screenlocerapp.PinLockAdapter;
import com.example.screenlocerapp.PinLockListener;
import com.example.screenlocerapp.ResourceUtils;

/**
 * Represents a numeric lock view which can used to taken numbers as input.
 * The length of the input can be customized using {@link com.example.screenlocerapp.PinLockView#setPinLength(int)}, the default value being 4
 * <p/>
...
public class PinLockView extends RecyclerView {
    ...
    /**
     * Resets the {@link com.example.screenlocerapp.PinLockView}, clearing the entered pin
    ...
    /**
     * Returns true if {@link IndicatorDots} are attached to {@link com.example.screenlocerapp.PinLockView}
     *
    ...
    /**
     * Attaches {@link IndicatorDots} to {@link com.example.screenlocerapp.PinLockView}
     *
